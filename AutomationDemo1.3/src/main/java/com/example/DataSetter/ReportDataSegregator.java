...
public class ReportDataSegregator {
	...
	static Sprinklr_NonVideoDto sprinklr_NonVideoDto = new Sprinklr_NonVideoDto();

	static Sprinklr_VideoDto sprinklr_VideoDto = new Sprinklr_VideoDto();

	List<Sprinklr_NonVideoDto> sprinklr_NonVideoDtoList = new ArrayList<Sprinklr_NonVideoDto>();

	List<Sprinklr_VideoDto> sprinklr_VideoDtoList = new ArrayList<Sprinklr_VideoDto>();
	...
	public void segregatingDataInRespectiveFileds(List<SummaryHpDto> reportDtoList, List<VantageDto> vantageDtoList,
		...
		for (SummaryHpDto summaryHpDto : reportDtoList) {
			...
			sprinklr_NonVideoDto = new Sprinklr_NonVideoDto();

			sprinklr_VideoDto = new Sprinklr_VideoDto();
			...
			if (StringUtils.containsIgnoreCase(summaryHpDto.getSource(), "Sprinklr VIDEO")) {

				sprinklr_VideoDto.setDate(summaryHpDto.getDate());
				sprinklr_VideoDto.setExchangeToDs(summaryHpDto.getNmExchange());
				sprinklr_VideoDto.setDsFromExchange(summaryHpDto.getHpExchange());
				sprinklr_VideoDto.setVariance(summaryHpDto.getDifference());

				sprinklr_VideoDtoList.add(sprinklr_VideoDto);

			}

			if (StringUtils.containsIgnoreCase(summaryHpDto.getSource(), "Sprinklr NON VIDEO")) {

				sprinklr_NonVideoDto.setDate(summaryHpDto.getDate());
				sprinklr_NonVideoDto.setExchangeToDs(summaryHpDto.getNmExchange());
				sprinklr_NonVideoDto.setDsFromExchange(summaryHpDto.getHpExchange());
				sprinklr_NonVideoDto.setVariance(summaryHpDto.getDifference());

				sprinklr_NonVideoDtoList.add(sprinklr_NonVideoDto);
		...
		sprinklr_NonVideoDtoList.forEach(n -> System.out.println(n));

		sprinklr_VideoDtoList.forEach(n -> System.out.println(n));
		...
		dataPrinter.printAllDatainExcel(confluenceList, emailList, globalRelayList, mrrList, ringCentralList,
				riverRunList, skypeList, socialMediaList, zoomList, sprinklr_NonVideoDtoList, sprinklr_VideoDtoList,
				dateList, fileLocation);
