...
public class SummaryHpReport {
	...
	public static String lineSkipper = System.lineSeparator();

	static StringBuilder builder = new StringBuilder();

	static ReportDataSetter reportDataSetter = new ReportDataSetter();

	static AutomationDemoLauncher launcher = new AutomationDemoLauncher();
	...
	public static void begin() throws InterruptedException, IOException, ParseException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\" + AutomationDemoLauncher.getUserDetails()
				+ "\\Downloads\\chromedriver_win32-New\\chromedriver.exe");
		...
		while (!StringUtils.containsIgnoreCase(driver.getPageSource().toString(), ">Reconciliation Report - HP")) {
			...
			System.out.println("Waiting_Summary_Hp page Response......" + responseWaiter);
	...
	public static void dataSetterInDto(String reportData) throws InterruptedException, IOException, ParseException {
		...
		System.out.println(lineSkipper + "Summary Hp Page Data Successful (1/4)........");
